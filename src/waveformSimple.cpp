...
waveformSimple::waveformSimple(const Double_t *wfT, const Double_t *wfA, Int_t nPoints, Int_t nPointsBaseLine, Int_t nSplinePoints, Int_t sigPolarity){
  if(nSplinePoints<=0){
    cout<<"  ERROR --> nSplinePoints <= 0"<<endl
	<<"            nSplinePoints  = "<<nSplinePoints<<endl;
    assert(0);
...
void waveformSimple::findPar( Double_t tLeft, Double_t tRight, Double_t  vVal, Double_t cfdValForTiming){
